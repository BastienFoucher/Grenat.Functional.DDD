...
[TestClass]
public class EntityMemberSettersTest : EntityTestBase
{
    [TestMethod]
    ...
    [TestMethod]
    public void Test050_When_setting_a_nullmemberin_an_entity_using_an_action_then_the_entity_is_not_updated()
    {
        List<int> list = null!;
