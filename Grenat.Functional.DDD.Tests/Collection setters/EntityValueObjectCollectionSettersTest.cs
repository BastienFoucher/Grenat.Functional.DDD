...
public class EntityValueObjectCollectionSettersTest : TestBase
{
    ...
    {
        ImmutableList<ValueObject<PositiveValueObject>> valueObjects = ImmutableList<ValueObject<PositiveValueObject>>.Empty;
        valueObjects = valueObjects.Add(PositiveValueObject.Create(1));
        valueObjects = valueObjects.Add(PositiveValueObject.Create(2));
    ...
    {
        var valueObjects = ImmutableList<ValueObject<PositiveValueObject>>.Empty;
        valueObjects = valueObjects.Add(PositiveValueObject.Create(1));
        valueObjects = valueObjects.Add(PositiveValueObject.Create(2));
    ...
    {
        var valueObjects = ImmutableDictionary<int, Entity<ChildEntity>>.Empty;
        valueObjects = valueObjects.Add(1, ChildEntity.Create(1));
        valueObjects = valueObjects.Add(2, ChildEntity.Create(2));
